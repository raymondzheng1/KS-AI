 ...
 * a compact nav on desktop, and an optional right-side action slot (e.g. the
 * room's "Continue" button). On `home` the lockup is static (no self-link).
 * The full nav lives in the shared footer for small screens.
 */
export function SiteHeader({ home = false, action }: { home?: boolean; action?: React.ReactNode }) {
  return (
